        ...
        >
            <CardBody className="p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-4 mb-5">
                        <div
                            className={`p-2 rounded-2xl ${color} shadow-lg group-hover:scale-105 transition-all duration-300`}
                        >
                            {icon}
                        </div>
...
const Dashboard: React.FC<DashboardProps> = ({ session }) => {
    ...
    const allTools = [
        ...
        },
        {
            ...
            icon: <Image src="/unahon_logo.png" alt="Unahon" width={40} height={40} className="w-10 h-10 object-contain rounded-full" />,
